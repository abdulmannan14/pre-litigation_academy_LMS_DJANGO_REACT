export default function Button({
  ...
  const variants = {
    primary:
      'bg-secondary text-white hover:bg-secondaryDark focus:ring-secondary shadow-md hover:shadow-lg',
    outline:
    ...
    danger: 'bg-red-500 text-white hover:bg-red-700 focus:ring-red-400 shadow-sm',
  };
